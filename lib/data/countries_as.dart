...
class Countries_as extends StatefulWidget {
  @override
  _Countries_asState createState() => _Countries_asState();
}

// ignore: camel_case_types
class _Countries_asState extends State<Countries_as> {
  List _countries = [];
  ...
  void loadCountry() async {
    ...
    for (var item in _countries) {
      if (item['continent'] != null && item['continent'] == 'AS') {
