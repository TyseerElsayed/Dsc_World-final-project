...
class Countries_sa extends StatefulWidget {
  @override
  _Countries_saState createState() => _Countries_saState();
}

// ignore: camel_case_types
class _Countries_saState extends State<Countries_sa> {
  List _countries = [];
  ...
  void loadCountry() async {
    ...
    for (var item in _countries) {
      if (item['continent'] != null && item['continent'] == 'SA') {
