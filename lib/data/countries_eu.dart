...
class Countries_eu extends StatefulWidget {
  @override
  _Countries_euState createState() => _Countries_euState();
}

// ignore: camel_case_types
class _Countries_euState extends State<Countries_eu> {
  List _countries = [];
  ...
  void loadCountry() async {
    ...
    for (var item in _countries) {
      if (item['continent'] != null && item['continent'] == 'EU') {
