...
class Countries_au extends StatefulWidget {
  @override
  _Countries_auState createState() => _Countries_auState();
}

// ignore: camel_case_types
class _Countries_auState extends State<Countries_au> {
  List _countries = [];
  ...
  void loadCountry() async {
    ...
    for (var item in _countries) {
      if (item['continent'] != null && item['continent'] == 'OC') {
